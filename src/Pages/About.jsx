        ...
        <div className="flex flex-wrap items-center">
          ...
          >
            <p className="text-lg mb-4">
              Hello! I'm [Your Name], a passionate web developer and designer with a keen interest in creating immersive
              and interactive web experiences. With [X] years of experience in the industry, I've had the opportunity to
